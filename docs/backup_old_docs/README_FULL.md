...
| [logger.py](../scripts/utils/logger.py) | - | 统一日志管理 |

### 辅助模块

- **[main.py](../scripts/main.py)**: 演示入口
- **[pipeline.py](../scripts/pipeline.py)**: 完整管道集成
...
**当前版本**: v2.0-simplified (2026-05-25)  
**最新功能**: Preset配置系统 + 文档简化重构
...
**最近改进** (v2.0):
- 🎯 **Preset配置系统** - 1行代码即可开始，降低90%配置复杂度 ⭐新增
- 📚 **文档简化** - README从1053行精简到235行，提升可读性 ⭐新增
- 🏗️ **分目录架构** - scripts目录按职责分组（core/generation/optimization/training/utils）
- 📝 统一使用绝对导入策略，提高代码可维护性
- ✅ 所有测试通过（8项核心测试）
